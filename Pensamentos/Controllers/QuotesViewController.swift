...
class QuotesViewController: UIViewController {
    ...
    @IBOutlet weak var lbAuhtor: UILabel!
    ...
    func formatView() {
        ...
        lbAuhtor.textColor = config.colorScheme == 0 ? UIColor(red: 192.0/255.0, green: 96.0/255.0, blue: 49.0/255.0, alpha: 1.0) : .yellow
        prepareQuote()
    }
    ...
    func showRandomQuote() {
        ...
        //lbAuhtor.text = quote.author
        lbAuhtor.text = quote.authorFormatted
